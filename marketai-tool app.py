Perfect ✅  
Here is your **FULL working Lean SaaS MVP code** with:

✅ 7‑Day Trial system  
✅ Trial expiry check  
✅ 200 contact trial limit  
✅ Flexible Excel column detection (Name / Phone / Contact / Number etc.)  
...
1. Send payment via UPI to: **yourupi@bank**  
2. Email payment screenshot to: **your@email.com**  
3. We activate your Pro plan within 24 hours.
""")
```
